          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <p className="text-white text-sm font-montserrat mt-4">
                  ...
                  curiosity, creativity, and character in every student,
                  preparing them for a successful future both academically and
                  socially.
                </p>
              </div>
              ...
              <div>
                ...
                <ul>
                  <li className="mb-2">
                    <Link
                      to="/"
                      className="text-white hover:text-black font-montserrat transition duration-300 no-underline"
                    >
                      Home
                    </Link>
                  </li>
            ...
            <div className="flex flex-col sm:flex-row justify-between px-4 border-t border-gray-700 font-montserrat pt-2 text-center">
              ...
              <div className="flex flex-col sm:flex-row space-x-0 sm:space-x-4 mt-2 sm:mt-0">
                <Link
                  className="text-gray font-montserrat font-bold no-underline hover:text-black"
                  to="/privacy-policy"
                >
                  Privacy Policy
                </Link>
